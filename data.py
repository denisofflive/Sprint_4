...
user_1 = User(MainPageLocators.button_order_up,
                  "Ольховая", "Денис", "Денисов",
                  "Москва, ул Ольховая, 25 кв 25", "89776136969",
                  "23.05.2023", 3, 1, "Домофон не работает, необходимо будет позвонить перед подъездом")


user_2 = User(MainPageLocators.button_order_down,
                  "Прокшино", "Марина", "Денисова",
                  "Москва, ул Веласкеса, 8 кв 12", "89456136933",
